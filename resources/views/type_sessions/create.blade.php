<x-layouts::app title="Nouveau Type de Session">
    <style>
        :root {
    ...
    <div class="content-wrapper" style="padding: 2rem;">
        ...
        <form method="POST" action="{{ route('type_sessions.store') }}" style="background: white; padding: 2rem; border-radius: var(--radius-lg); box-shadow: var(--shadow-md); border: 1px solid var(--color-gray-100);">
            @csrf
            ...
            <div style="margin-bottom: 2.5rem;">
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1.5rem; margin-bottom: 2rem;">
                    ...
                    <label for="type_code" style="cursor: pointer;">
                        ...
                        <div id="card_code"
                             ...
                             onmouseover="this.style.borderColor='var(--color-green)'; this.style.boxShadow='0 0 0 3px rgba(0,122,94,0.1)'"
                             onmouseout="updateCard()">
                    ...
                    <label for="type_creneau" style="cursor: pointer;">
                        <input type="radio" id="type_creneau" name="type" value="creneau"
                               {{ old('type') == 'creneau' ? 'checked' : '' }}
                               style="display: none;"
                               onchange="updateCard()">
                        <div id="card_creneau"
                             style="border: 2px solid var(--color-gray-200); border-radius: var(--radius-lg); padding: 1.5rem; text-align: center; transition: all var(--transition-normal); cursor: pointer;"
                             onmouseover="this.style.borderColor='var(--color-gold)'; this.style.boxShadow='0 0 0 3px rgba(252,209,22,0.2)'"
                             onmouseout="updateCard()">
                            <div style="font-size: 2.5rem; margin-bottom: 0.75rem;">🔧</div>
                    ...
                    <label for="type_conduite" style="cursor: pointer;">
                        <input type="radio" id="type_conduite" name="type" value="conduite"
                               {{ old('type') == 'conduite' ? 'checked' : '' }}
                               style="display: none;"
                               onchange="updateCard()">
                        <div id="card_conduite"
                             style="border: 2px solid var(--color-gray-200); border-radius: var(--radius-lg); padding: 1.5rem; text-align: center; transition: all var(--transition-normal); cursor: pointer;"
                             onmouseover="this.style.borderColor='var(--color-red)'; this.style.boxShadow='0 0 0 3px rgba(206,17,38,0.1)'"
                             onmouseout="updateCard()">
                            <div style="font-size: 2.5rem; margin-bottom: 0.75rem;">🚗</div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="3"
                              placeholder="Description complémentaire du type de session..."
                              ...
                              onblur="this.style.borderColor='var(--color-gray-200)'; this.style.boxShadow='none'">{{ old('description') }}</textarea>
                </div>
            </div>
        ...
        <div style="margin-top: 2rem; padding: 1rem; background: rgba(0,122,94,0.1); border-left: 4px solid var(--color-green); border-radius: var(--radius-md); color: var(--color-green-dark); font-size: 0.875rem;">
            <strong>ℹ️ Information :</strong> Chaque type correspond à une phase de la formation au permis E : <strong>Code</strong> → <strong>Créneau</strong> → <strong>Conduite</strong>.
        </div>
    </div>
    ...
    <script>
        ...
        // Appliquer au chargement (si old value après erreur)
