<x-layouts::app.sidebar title="Modifier Lieu de Formation">
    ...
    <div class="content-wrapper" style="padding: 2rem;">
        ...
        <form method="POST" action="{{ route('lieu_formations.update', $lieuFormation->id) }}" style="background: white; padding: 2.5rem; border-radius: var(--radius-lg); box-shadow: var(--shadow-md); border: 1px solid var(--color-gray-100);">
            @csrf @method('PUT')
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                <div class="form-group">
                    ...
                    <input type="text" name="nomLieu" value="{{ old('nomLieu', $lieuFormation->nomLieu) }}" required
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="localisation" value="{{ old('localisation', $lieuFormation->localisation) }}" required
                           style="width: 100%; padding: 0.75rem 1rem; border: 2px solid var(--color-gray-200); border-radius: var(--radius-md); transition: var(--transition-normal);"
                           onfocus="this.style.borderColor='var(--color-green)'; this.style.boxShadow='0 0 0 3px rgba(0, 122, 94, 0.1)'"
                           onblur="this.style.borderColor='var(--color-gray-200)'; this.style.boxShadow='none'">
                </div>
            ...
            <div style="display: flex; gap: 1rem; margin-top: 3rem; padding-top: 2rem; border-top: 1px solid #eee;">
                <button type="submit" style="background: linear-gradient(135deg, var(--color-green) 0%, var(--color-green-dark) 100%); color: white; padding: 0.875rem 2.5rem; border-radius: var(--radius-md); border: none; font-weight: 600; cursor: pointer; text-transform: uppercase; font-size: 0.85rem;">✓ Mettre à jour</button>
