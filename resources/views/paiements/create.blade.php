        ...
        <form method="POST" action="{{ route('paiements.store') }}">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="montant" class="form-input" placeholder="Ex: 50000" value="{{ old('montant') }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="datePaiement" class="form-input" value="{{ old('datePaiement') }}" required>
