<x-layouts::app.sidebar title="Modifier Formation">
    ...
    <div class="content-wrapper" style="padding: 2rem;">
        ...
        <!-- Formulaire -->
        <form method="POST" action="{{ route('formations.update', $formation->id) }}" style="background: white; padding: 2rem; border-radius: var(--radius-lg); box-shadow: var(--shadow-md); border: 1px solid var(--color-gray-100);">
            @csrf
            @method('PUT')
