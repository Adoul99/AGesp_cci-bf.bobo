...
<div class="content-wrapper">
    ...
    <h1 class="cp-title">Modifier Formation</h1>
            ...
            <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px,1fr)); gap:1.75rem;">
                ...
                <div>
                    ...
                    <input type="text" id="lieu" name="lieu" value="{{ old('lieu', $formation->lieu) }}"
                           class="cp-input @error('lieu') is-invalid @enderror" required>
                ...
                <div>
                    ...
                    <input type="date" id="dateDebut" name="dateDebut" value="{{ old('dateDebut', $formation->dateDebut) }}"
                ...
                <div>
                    ...
                    <input type="date" id="dateFin" name="dateFin" value="{{ old('dateFin', $formation->dateFin) }}"
